  ...
  return (
    <footer className="w-full z-40 transition-all duration-300 ease-in-out mt-auto" 
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-3">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div>
            <Link to="/" className="inline-block">
              <span className="animate-random-text font-bold text-xl tracking-wider font-orbitron">
                STAR<span className="text-white">SHIFT</span>
              </span>
            </Link>
          </div>
          ...
          <div className="text-center">
            <div className="text-gray-400 text-sm tracking-wide">
              <p className="hover:text-gray-300 transition-colors duration-200">info@starshift.com</p>
              <p className="hover:text-gray-300 transition-colors duration-200">+1 (555) 123-4567</p>
            </div>
          </div>
        ...
        {/* Copyright */}
        <div className="mt-3 pt-3 flex flex-col sm:flex-row justify-between items-center gap-4 border-t border-white/5">
